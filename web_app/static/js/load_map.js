function loadMapImage() {
    ...
    if (mapContainer) {
        ...
        img_g.src = `/get_global_map_image?t=${timestamp}`; // Используем маршрут для получения изображения
...
function toggleImages() {
    const image1 = document.getElementById('global_image');
    const image2 = document.getElementById('curr_image');
